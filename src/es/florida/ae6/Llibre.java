...
//		super();
	...
	// Constructor: Llibre
	// Descripcio: constructor de la clase llibre per a quan creem l'objecte amb
	// identificador
	// Parametres d'entrada: String identificador, String titol, String autor,
	// String anyNaixement, String anyPublicacio, String editorial, String
	// numPagines
	// Parametres de salida: no.
	public Llibre(Integer identificador, String titol, String autor, String anyNaixement, String anyPublicacio,
			String editorial, String numPagines) {
	...
	// numPagines
	// Parametres de salida: no.
	public Llibre(String titol, String autor, String anyPublicacio, String editorial, String numPagines) {
		this.titol = titol;
		this.autor = autor;
		this.anyNaixement = anyNaixement;
		this.anyPublicacio = anyPublicacio;
	...
	// Metode: getAnyNaixement
	// Descripcio: metode retorna la variable anyNaixement.
	// Parametres d'entrada: no.
	// Parametres de salida: String anyNaixement
	public String getAnyNaixement() {
		return anyNaixement;
	}

	// Metode: setAnyNaixement
	// Descripcio: metode que cambia el valor per el del parametre
	// Parametres d'entrada: String anyNaixement
	// Parametres de salida: no.
